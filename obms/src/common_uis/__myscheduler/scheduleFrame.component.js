                  ...
                  <td className="fc-head-container fc-widget-header">
                    <div className="fc-row fc-widget-header">
                      <table>
                        ...
                        <ScheduleResources resources={this.props.resources} isHeader={true}/>
                  ...
                  <td className="fc-widget-content">
                    ...
                    <div className="fc-day-grid fc-unselectable">
                      <div className="fc-row fc-week fc-widget-content">
                        <div className="fc-bg">
                          <table>
                            <ScheduleResources resources={this.props.resources}/>
                            {/*
                              <tbody>
                                <tr>
                        ...
                        <div className="fc-content-skeleton">
                          <table>
                            <ScheduleResources resources={this.props.resources} isContent={true}/>
                            {/*
                              <tbody>
                                <tr>
                    ...
                    <div className="fc-scroller fc-time-grid-container" style={{overflowX: 'hidden', overflowY: 'scroll', height: '601px'}}>
                      <div className="fc-time-grid fc-unselectable">
                        ...
                        <div className="fc-slats">
                          <table>
                            <ScheduleTimes fromTime={this.props.fromTime} toTime={this.props.toTime} duration={this.props.duration}/>
                          </table>
                        </div>
                        {/* End time slots */}
